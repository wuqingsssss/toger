...
class ControllerPromotionPromotion extends Controller {
	...
	private function getList() {
		...
		$this->document->setTitle(empty($promotion['share_title'])?$promotion['pb_name']:$promotion['share_title'].$promotion['share_desc']);
		...
		foreach ($results as $product) {
			...
			if ($product_info) {
				...
				$progroups[$product['pr_group']][] = $product_info;
			}
		...
		{
			$this->data['progroups'][$key]=changeProductResults($group,$this);
