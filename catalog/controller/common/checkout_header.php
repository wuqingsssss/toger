<?php   
class ControllerCommonCheckoutHeader extends Controller {
	protected function index() {
		...
		$this->data['policy'] = $this->url->link('information/policy', '', 'SSL');
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/common/checkout_header.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/common/checkout_header.tpl';
		} else {
			$this->template = 'default/template/common/checkout_header.tpl';
		}
