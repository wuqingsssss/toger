...
class ControllerCheckoutPayment extends Controller {
	public function index() {
		...
		if ($this->request->server['REQUEST_METHOD'] == 'POST') {
			...
			if(isset($this->request->post['pay_bank'])){
				$this->session->data['pay_bank']=$this->request->post['pay_bank'];
				$this->data['pay_bank']=$this->session->data['pay_bank'];
			}else{
				if(isset($this->request->post['payment_method'])&&$this->request->post['payment_method']!='alipaybank'){
					if(isset($this->session->data['pay_bank'])){
