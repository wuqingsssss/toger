...
class ControllerAffiliateEdit extends Controller {
	...
	public function index() {
		...
		$this->load_language('affiliate/edit');
		...
		if (isset($this->request->post['city_id'])) {
			...
			$this->data['city_id'] = $affiliate_info['city_id'];		
		} else {
			$this->data['city_id'] = '';
		}
	...
	private function validate() {
  	...
  	public function zone() {
    	...
    	$results = $this->model_localisation_zone->getZonesByCountryId($this->config->get('config_country_id'));
