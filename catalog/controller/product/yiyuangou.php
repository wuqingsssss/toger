<?php 
class ControllerProductYiyuangou extends Controller {  
	...
	//		'sort'               => -1,
		...
		$this->data['filter_category_id']          = 55;//$filter_data['filter_category_id'];
		$this->session->data['filter_category_id'] = 55;//$filter_data['filter_category_id'];		
