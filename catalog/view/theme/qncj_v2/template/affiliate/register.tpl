  ...
  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="register">
    ...
    <div class="buttons">
      <div class="right"><?php echo $text_agree; ?>
        ...
        <?php } ?>
        <a onclick="$('#register').submit();" class="button"><span><?php echo $button_register; ?></span></a></div>
    </div>
    <?php } else { ?>
    <div class="buttons">
      <div class="right"><a onclick="$('#register').submit();" class="button"><span><?php echo $button_register; ?></span></a></div>
    </div>
    <?php } ?>
  </form>
