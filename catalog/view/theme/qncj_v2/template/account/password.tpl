    ...
    <div class="content">
      <table class="form">
       <tr>
          ...
          <input type="password" name="old_password" class="span4" value="<?php echo $old_password; ?>" />
        ...
        <tr>
          ...
          <input type="password" name="password" class="span4" value="<?php echo $password; ?>" />
        ...
        <tr>
          ...
          <input type="password" name="confirm" class="span4" value="<?php echo $confirm; ?>" />
