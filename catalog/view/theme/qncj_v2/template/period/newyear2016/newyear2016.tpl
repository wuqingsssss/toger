...
<?php
$tplPath = 'catalog/view/theme/'.$this->config->get('config_template').'/template/period/'.$supply_period['template'].'/';
$cssPath = 'catalog/view/theme/'.$this->config->get('config_template').'/template/period/'.$supply_period['template'].'/';
$jsPath =  'catalog/view/theme/'.$this->config->get('config_template').'/template/period/'.$supply_period['template'].'/js/';
$imgPath = 'catalog/view/theme/'.$this->config->get('config_template').'/template/period/'.$supply_period['template'].'/img/';
?>
