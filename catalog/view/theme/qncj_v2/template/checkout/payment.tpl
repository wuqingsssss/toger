...
<ul class="bank-list">
			<?php foreach ($pay_banks as $key ) { ?>
				...
				<li>
					<label>
						<input type="radio" name="pay_bank" value="<?php echo $key;?>" checked="checked"/>
						<span class="bank-icon <?php echo $key;?>"></span>
					</label>
				</li>
			<?php } else {?>
				<li>
					<label>
						<input type="radio" name="pay_bank" value="<?php echo $key;?>"/>
						<span class="bank-icon <?php echo $key;?>"></span>
					</label>
				</li>
			<?php }?>
