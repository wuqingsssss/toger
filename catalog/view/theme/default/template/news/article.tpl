...
<?php if ($thumb) { ?>
<a href="<?php echo $popup; ?>" title="<?php echo $heading_title; ?>" class="fancybox"><img style="padding: 8px; background: #eee; border: 1px solid #ddd; margin-left: 15px; margin-bottom: 10px;" align="right" src="<?php echo $thumb; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" id="image" /></a>
<?php } ?>
...
<?php if ($products) { ?>
<div style="font-size: 16px; font-weight: bold; text-decoration: none; margin-bottom: 7px; margin-left: 5px;">
