...
<thead>
  ...
  <tr>
    ...
    <input type="button" onclick="shopcart_downToCart('<?php echo $product['product_id']; ?>');" value=" - " class="down" alt="<?php echo $text_minus; ?>" title="<?php echo $text_minus; ?>">
...
<!--    <input style="min-width:10px;" type="text" name="quantity[<?php echo $product['key']; ?>]" id="product_<?php echo $product['product_id']; ?>_quantity" value="<?php echo $product['quantity']; ?>" size="3" />-->
    <input type="button" onclick="shopcart_upToCart('<?php echo $product['product_id']; ?>');" value=" + " class="up" title="<?php echo $text_plus; ?>">
    </td>
