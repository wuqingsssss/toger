    ...
    <div class="content">
      <table class="form">
       ...
       <tr>
          ...
          <td><input type="text" name="address_1" value="<?php echo $address_1; ?>" class="span6" />
        ...
        <tr><td>&nbsp;</td>
        <td><div class="left"><a onclick="$('#address').submit();" class="button"><span><?php echo $button_save; ?></span></a></div></td>
        </tr>
      </table>
    </div>
  </form>
