...
class ControllerSaleCustomerGroup extends Controller {
	...
	public function index() {
		$this->load_language('sale/customer_group');
	...
	private function getForm() {
		...
		if (isset($this->request->post['level'])) {
			...
			$this->data['level'] = $customer_group_info['level'];
		} else {
			$this->data['level'] = 0;
		}
		
		if (isset($this->request->post['level_des'])) {
			$this->data['level_des'] = $this->request->post['level_des'];
		} elseif (isset($customer_group_info)) {
			$this->data['level_des'] = $customer_group_info['level_des'];
		} else {
			$this->data['level_des'] = '';
		}
