...
class ControllerDesignBanner extends Controller {
	...
	protected function init(){
		$this->load_language('design/banner');
	...
	private function getList() {
		...
		foreach ($results as $result) {
			...
			$action[] = array(
				'text' => '周期',
				'href' => $this->url->link('design/banner_period', 'banner_id=' . $result['banner_id'] . $url, 'SSL')
			);
	...
	private function getForm() {
		...
		if (isset($this->request->post['language_id'])) {
			...
			$this->data['language_id'] = $banner_info['language_id'];
		} else {
			$this->data['language_id'] = true;
		}
