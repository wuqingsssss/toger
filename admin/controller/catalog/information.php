...
class ControllerCatalogInformation extends Controller { 
	...
	private function getList() {
    	...
    	foreach ($results as $result) {
			...
			$this->data['informations'][] = array(
				...
				'title'          => $result['title'],
				'group'          => $this->model_catalog_information_group->getInformationGroupName($result['group_id']),
	...
	private function getForm() {
		...
		if (isset($this->request->post['group_id'])) {
			...
			$this->data['group_id'] = $information_info['group_id'];
		} else {
		...
		$results=$this->model_catalog_information_group->getInformationGroupOptions();
		
		$this->data['information_groups']=array();
		
		foreach($results  as $result){
			$this->data['information_groups'][]=array(
				'value' =>$result['information_group_id'],
				'name' =>$result['name']
			);
		}
