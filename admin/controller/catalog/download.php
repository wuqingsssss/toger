...
class ControllerCatalogDownload extends Controller {  
	private $error = array();
  	...
  	public function index() {
		$this->load_language('catalog/download');
  	...
  	private function getForm() {
		...
		$this->data['categories'] = $this->model_catalog_download->getCategories(0);
		...
		if (isset($this->request->post['download_category'])) {
			...
			$this->data['download_category'] = $this->model_catalog_download->getDownloadCategories($this->request->get['download_id']);
		} else {
