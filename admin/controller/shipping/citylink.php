...
class ControllerShippingCitylink extends Controller {
	...
	public function index() {   
		$this->load_language('shipping/citylink');
		...
		if (isset($this->request->post['citylink_description'])) {
			$this->data['citylink_description'] = $this->request->post['citylink_description'];
		} else {
			$this->data['citylink_description'] = $this->config->get('citylink_description');
		}
		...
		if (isset($this->request->post['citylink_zone_id'])) {
			$this->data['citylink_zone_id'] = $this->request->post['citylink_zone_id'];
		} else {
			$this->data['citylink_zone_id'] = $this->config->get('citylink_zone_id');
		}
		
		if (isset($this->request->post['citylink_city_id'])) {
			$this->data['citylink_city_id'] = $this->request->post['citylink_city_id'];
		} else {
			$this->data['citylink_city_id'] = $this->config->get('citylink_city_id');
		}
