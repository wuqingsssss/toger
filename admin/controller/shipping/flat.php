...
class ControllerShippingFlat extends Controller {
	...
	public function index() {   
		$this->load_language('shipping/flat');
		...
		if (isset($this->request->post['flat_description'])) {
			$this->data['flat_description'] = $this->request->post['flat_description'];
		} else {
			$this->data['flat_description'] = $this->config->get('flat_description');
		}
