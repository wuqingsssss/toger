...
class ControllerLocalisationZone extends Controller {
	...
	public function index() {
		$this->load_language('localisation/zone');
	...
	private function getForm() {
		...
		if (isset($this->request->post['name_fix'])) {
			$this->data['name_fix'] = $this->request->post['name_fix'];
		} elseif (isset($zone_info)) {
			$this->data['name_fix'] = $zone_info['name_fix'];
		} else {
			$this->data['name_fix'] = '';
		}
