        ...
        <tbody>
          ...
          <?php foreach ($extensions as $extension) { ?>
            <?php if($extension['installed']) {?>
	          <tr>
	             <td class="left"> 
	            <?php if($default_promotion==$extension['code']){ ?>
	           		 <input type="radio" checked="checked"  name="config_default_promotion" value="<?php echo $extension['code']; ?>" />
	            <?php }else { ?>
	            	 <input type="radio" name="config_default_promotion" value="<?php echo $extension['code']; ?>" />
	            <?php } ?>
	            </td>
