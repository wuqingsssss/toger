        ...
        <table id="tax-rate" class="list">
          ...
          <tbody id="tax-rate-row<?php echo $tax_rate_row; ?>">
            <tr>
              ...
              <td class="left"><a onclick="$('#tax-rate-row<?php echo $tax_rate_row; ?>').remove();" class="button"><span><?php echo $button_remove; ?></span></a></td>
            </tr>
          </tbody>
          <?php $tax_rate_row++; ?>
          <?php } ?>
...
function addRate() {
	...
	html += '<td class="left"><a onclick="$(\'#tax-rate-row' + tax_rate_row + '\').remove();" class="button"><span><?php echo $button_remove; ?></span></a></td>';
	html += '</tr>';
	html += '</tbody>';
