      ...
      <table class="list">
        <thead>
          <tr>
            ...
            <td class="left"><?php if ($sort == 'city_name') { ?>
              ...
              <?php } ?></td>
              <td class="left"><?php if ($sort == 'city_name_fix') { ?>
              <a href="<?php echo $sort_name_fix; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_name_fix; ?></a>
              <?php } else { ?>
              <a href="<?php echo $sort_name_fix; ?>"><?php echo $column_name_fix; ?></a>
              <?php } ?></td>
        ...
        <tbody>
          <tr class="filter">
            ...
            <td></td>
	    <td><input type="text" name="filter_code" class="span1" value="<?php echo $filter_code; ?>" /></td>
          ...
          <tr>
            <td style="text-align: center;"><?php if ($city['selected']) { ?>
              ...
              <?php } ?></td>
            <td class="left"><?php echo $city['zone'].$city['zone_fix']; ?></td>
            <td class="left"><?php echo $city['name']; ?></td>
            <td class="left"><?php echo $city['name_fix']; ?></td>
