  ...
  <div class="content">
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      <table class="form">
        ...
        <tr>
		<td><?php echo $entry_trade_type_bank; ?></td>
          <td>
			 <?php if ($alipay_trade_bank=='bank') { ?>
				<input type="checkbox" name="alipay_trade_bank" value="bank" checked="checked"/>&nbsp;&nbsp;
			<?php } else  {  ?>
				<input type="checkbox" name="alipay_trade_bank" value="bank"/>&nbsp;&nbsp;
