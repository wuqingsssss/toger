          ...
          <div id="tab-language-<?php echo $module_row; ?>-<?php echo $language['language_id']; ?>">
            <table class="form">
              <tr>
                ...
                <td>
                <textarea name="welcome_module[<?php echo $module_row; ?>][description][<?php echo $language['language_id']; ?>]" id="description-<?php echo $module_row; ?>-<?php echo $language['language_id']; ?>"><?php echo isset($module['description'][$language['language_id']]) ? $module['description'][$language['language_id']] : ''; ?></textarea>
                </td>
              </tr>
            </table>
          </div>
          ...
          <table class="form">
            ...
            <tr>
              ...
              <td><select name="welcome_module[<?php echo $module_row; ?>][position]">
                ...
                <input type="hidden" name="welcome_module[<?php echo $module_row; ?>][layout_module_id]" value="<?php echo $module['layout_module_id']; ?>"/>
                </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td><input type="text" name="welcome_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $module['sort_order']; ?>" size="3" /></td>
               ...
               <!-- tr>
              <td><?php echo $entry_link; ?>链接</td>
              <td>
                <input type="text" name="welcome_module[<?php echo $module_row; ?>][link][1]['href']" value="<?php echo $module['sort_order']; ?>" size="3" />
                <input type="text" name="welcome_module[<?php echo $module_row; ?>][link][1]['title']" value="<?php echo $module['sort_order']; ?>" size="3" />
                <input type="text" name="welcome_module[<?php echo $module_row; ?>][link][1]['class']" value="<?php echo $module['sort_order']; ?>" size="3" />
                <br/>
                <input type="text" name="welcome_module[<?php echo $module_row; ?>][link][2]['href']" value="<?php echo $module['sort_order']; ?>" size="3" />
                <input type="text" name="welcome_module[<?php echo $module_row; ?>][link][2]['title']" value="<?php echo $module['sort_order']; ?>" size="3" />
                <input type="text" name="welcome_module[<?php echo $module_row; ?>][link][2]['class']" value="<?php echo $module['sort_order']; ?>" size="3" />
                 <br/>
                <input type="text" name="welcome_module[<?php echo $module_row; ?>][link][3]['href']" value="<?php echo $module['sort_order']; ?>" size="3" />
                <input type="text" name="welcome_module[<?php echo $module_row; ?>][link][3]['title']" value="<?php echo $module['sort_order']; ?>" size="3" />
                <input type="text" name="welcome_module[<?php echo $module_row; ?>][link][3]['class']" value="<?php echo $module['sort_order']; ?>" size="3" />
                </td>
            </tr-->
          </table>
        </div>
...
function addModule() {	
	...
	<?php } ?>
	html += '      </select><input type="hidden" name="welcome_module[' + module_row + '][layout_module_id]" value=""/></td>';
	html += '    </tr>';
	html += '  <tr>\
     <td><?php echo $entry_template; ?></td>\
     <td>\
       <select name="welcome_module[' + module_row + '][template]">\
       <?php foreach($templates as $template) {?>\
