  ...
  <div id="tab_general" class="page">
	  ...
	  <table id="module" class="list">
        ...
        <tbody id="module-row<?php echo $module_row; ?>">
          <tr>
		  <td class="left"><input type="text" name="news_module[<?php echo $module_row; ?>][news_limit]" value="<?php echo $module['news_limit']; ?>" size="3" /></td>
...
function addModule() {	
	...
	html += '  <tr>';
	html += '    <td class="left"><input type="text" name="news_module[' + module_row + '][news_limit]" value="4" size="3" /></td>';
    ...
    html += '    </select></td>';
	html += '    <td class="right"><input type="text" name="news_module[' + module_row + '][sort_order]" value="" size="3" /></td>';
