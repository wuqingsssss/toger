        ...
        <tbody id="module-row<?php echo $module_row; ?>">
          <tr>
            <td class="left"><select name="slideshow_module[<?php echo $module_row; ?>][banner_id]">
                ...
                <?php } ?>
                <?php } ?>
              </select><input type="hidden" name="slideshow_module[<?php echo $module_row; ?>][layout_module_id]" value="<?php echo $module['layout_module_id']; ?>"/></td>
            <td class="left"><input type="text" name="slideshow_module[<?php echo $module_row; ?>][width]" value="<?php echo $module['width']; ?>" size="3" />
              ...
              <?php } ?></td>
                <td class="left"><input type="text" name="slideshow_module[<?php echo $module_row; ?>][class]" value="<?php echo $module['class']; ?>" class="input-mini" />
             </td>
            <td class="left"><select name="slideshow_module[<?php echo $module_row; ?>][layout_id]">
                ...
                <td class="left"><select name="slideshow_module[<?php echo $module_row; ?>][template]">
...
function addModule() {	
	...
	<?php } ?>
	html += '    </select><input type="hidden" name="slideshow_module[' + module_row + '][layout_module_id]" value=""/></td>';
	...
	html += '  <td class="left"><input type="text" name="slideshow_module[' + module_row + '][class]" value="" class="input-mini" />';
	html += '     </td>';
	...
	<?php } ?>
	html += '    </select></td>';
	html += '<td class="left"><select name="slideshow_module[' + module_row + '][template]">';
    <?php foreach($templates as $template) {?>
