        ...
        <tbody id="module-row<?php echo $module_row; ?>">
          <tr>
            ...
            <td class="left"><select name="cates_module[<?php echo $module_row; ?>][layout_id]">
               ...
               <td class="left"><select name="cates_module[<?php echo $module_row; ?>][template]">
            ...
            <td class="left"><select name="cates_module[<?php echo $module_row; ?>][position]">
                ...
                <td class="left"><select name="cates_module[<?php echo $module_row; ?>][filter]">
            ...
            <td class="left"><select name="cates_module[<?php echo $module_row; ?>][status]">
             ...
             <td class="left"><select name="cates_module[<?php echo $module_row; ?>][cate]">
               ...
               <td class="left"><input type="text" name="cates_module[<?php echo $module_row; ?>][title]" value="<?php echo $module['title']; ?>" size="5" /></td>
...
function addModule() {	
	...
	<?php } ?>
	html += '    </select></td>';
	html += '<td class="left"><select name="cates_module[' + module_row + '][template]">';
    <?php foreach($templates as $template) {?>
	...
	html += '    </select></td>';
	html += '    <td class="left"><select name="cates_module[' + module_row + '][filter]">';
    ...
    html += '   <?php } ?>';
    html += '          </select></td>';
    html += '    <td class="left"><input type="text" name="cates_module[' + module_row + '][title]" value="" size="5" /></td>';
    html += '    <td class="left"><input type="text" name="cates_module[' + module_row + '][count]" value="" size="3" /></td>';
	html += '    <td class="right"><input type="text" name="cates_module[' + module_row + '][sort_order]" value="100" size="3" /></td>';
