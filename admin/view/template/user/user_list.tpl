          ...
          <tbody>
            ...
            <tr>
              <td style="text-align: center;"><?php if ($user['selected']) { ?>
                ...
                <?php } ?></td>
               <td class="left"><?php if($user['is_admin']||$user['user_group_id']==1){?><img src="view/image/iocn_cartoon_red.png" style="height:18px;" /><?php }else{ ?><img src="view/image/iocn_cartoon_green.png" style="height:18px;" /><?php }?><?php echo $user['username']; ?></td>
