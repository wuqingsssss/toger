 <?php if ($error_warning) { ?>
  ...
  <div class="box">
    <div class="heading">
      ...
      <div class="buttons"><button onclick="$('#form').attr('action', '<?php echo $approve; ?>'); $('#form').submit();" class="btn"><?php echo $button_approve; ?></button> <button onclick="location = '<?php echo $insert; ?>'" class="btn btn-primary"><?php echo $button_insert; ?></button> <button onclick="$('#form').attr('action', '<?php echo $delete; ?>'); $('#form').submit();" class="btn"><?php echo $button_delete; ?></button></div>
    </div>
    <div class="content">
