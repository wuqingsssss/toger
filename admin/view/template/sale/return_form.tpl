        ...
        <div id="tab-return" class="vtabs-content">
          <table class="form">
            ...
            <tr>
              ...
              <td><input type="text" class="date" name="date_ordered" value="<?php echo $date_ordered; ?>"  /></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td><textarea name="comment" cols="20" rows="5"><?php echo $comment; ?></textarea></td>
            </tr>
          </table>
        </div>
          ...
          <table id="product" class="list">
            ...
            <tbody id="product-row<?php echo $product_row; ?>">
              <tr>
                ...
                <td class="left"><textarea name="return_product[<?php echo $product_row; ?>][comment]" cols="20" rows="5"><?php echo $return_product['comment']; ?></textarea></td>
...
function addProduct() {
    ...
    html += '    </select></td>';	
	html += '    <td class="left"><textarea name="return_product[' + product_row + '][comment]" cols="20" rows="5"></textarea></td>';
