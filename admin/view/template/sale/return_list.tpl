      ...
      <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="list">
          ...
          <tbody>
            <tr class="filter">
              <td></td>
              <td align="right"><input type="text" name="filter_return_id" class="span2" value="<?php echo $filter_return_id; ?>" size="4" style="text-align: right;" /></td>
              <td align="right"><input type="text" name="filter_order_id" class="span2" value="<?php echo $filter_order_id; ?>" size="4" style="text-align: right;" /></td>
              <td><input type="text" name="filter_customer" class="span2" value="<?php echo $filter_customer; ?>" /></td>
              <td align="right"><input type="text" name="filter_quantity" value="<?php echo $filter_quantity; ?>" size="4" class="span2" style="text-align: right;" /></td>
              <td><select name="filter_return_status_id" class="span1">
                  <option value="*"></option>
              ...
              <td><input type="text" name="filter_date_added" class="span2" value="<?php echo $filter_date_added; ?>" size="12" class="date" /></td>
              <td><input type="text" name="filter_date_modified" class="span2" value="<?php echo $filter_date_modified; ?>" size="12" class="date" /></td>
