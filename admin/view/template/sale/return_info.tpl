  ...
  <div class="box">
    <div class="heading">
      ...
      <div class="buttons"><a onclick="location = '<?php echo $cancel; ?>';" class="btn btn-primary"><span><?php echo $button_back; ?></span></a></div>
    </div>
    <div class="content">
      ...
      <div id="tab-history" class="vtabs-content">
        ...
        <table class="form">
          ...
          <tr>
            ...
            <td><textarea name="comment" cols="20" rows="8" style="width: 99%"></textarea>
              <div style="margin-top: 10px; text-align: left;"><a onclick="history();" id="button-history" class="btn"><span><?php echo $button_add_return; ?></span></a></div></td>
          </tr>
        </table>
      </div>
    </div>
