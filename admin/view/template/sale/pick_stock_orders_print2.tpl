        ...
        <div id="tab-product" class="vtabs-content i-main-print-zone i-force-print-full-width">
            ...
            <table id="products-tbl" class="list">
                ...
                <tr>
                    ...
                    <td class="left" style="width: 15%">单号</td>
                    <td class="left" style="width: 35%">菜品名称</td>
                    <td class="left" style="width: 10%">数量</td>
                    <td class="left" style="width: 10%">单位</td>
                    <td class="left" style="width: 20%">客户名称</td>
                    <td class="left" style="width: 20%">电话</td>
                </tr>
                </thead>
                <?php if (!empty($rows)) { ?>
                    <?php foreach ($rows as $index=>$item) { ?>
                        ...
                        <tr>
                            ...
                            <td class="left"><?php echo $item['order_id']; ?></td>
                            <td class="left">
                            ...
                            <td class="left"><?php echo $item['customer_name']; ?></td>
