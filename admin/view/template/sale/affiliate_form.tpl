        ...
        <div id="tab-general">
          <table class="form">
           ...
           <tr>
              ...
              <td><select name="zone_id" onchange="$('select[name=\'city_id\']').load('index.php?route=common/localisation/city&token=<?php echo $token; ?>&zone_id=' + this.value);">
                </select>
                <?php if ($error_zone) { ?>
           ...
           <script type="text/javascript"><!--
		    $('select[name=\'zone_id\']').load('index.php?route=common/localisation/zone&token=<?php echo $token; ?>&country_id=<?php echo $country_id; ?>&zone_id=<?php echo $zone_id; ?>');
            $('select[name=\'city_id\']').load('index.php?route=common/localisation/city&token=<?php echo $token; ?>&zone_id=<?php echo $zone_id; ?>&city_id=<?php echo $city_id; ?>');
		    //--></script> 
        </div>
        <div id="tab-payment">
          <table class="form">
