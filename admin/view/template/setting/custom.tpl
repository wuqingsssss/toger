    ...
    <div class="content">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
          <table class="form">
            ...
            <tr>
              <td><?php echo $entry_admin_language_status; ?></td>
              <td>
                <input type="radio" name="config_admin_language_status" value="1" <?php if ($config_admin_language_status) { ?> checked="checked"<?php }?> />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_admin_language_status" value="0" <?php if (! $config_admin_language_status) { ?> checked="checked"<?php }?> />
                <?php echo $text_no; ?>
              </td>
            </tr>
            <tr>
           ...
           <tr>
            ...
            <tr>
              ...
              <td><?php if ($config_reward_status) { ?>
                <input type="radio" name="config_reward_status" value="1" checked="checked" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_reward_status" value="0" />
                <?php echo $text_no; ?>
                <?php } else { ?>
                <input type="radio" name="config_reward_status" value="1" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_reward_status" value="0" checked="checked" />
                <?php echo $text_no; ?>
                <?php } ?></td>
            </tr>
          </table>
          ...
          <table class="form">
            ...
            <tr>
              <td><?php echo $entry_consulation_status; ?></td>
              <td><?php if ($config_consulation_status) { ?>
                <input type="radio" name="config_consulation_status" value="1" checked="checked" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_consulation_status" value="0" />
                <?php echo $text_no; ?>
                <?php } else { ?>
                <input type="radio" name="config_consulation_status" value="1" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_consulation_status" value="0" checked="checked" />
                <?php echo $text_no; ?>
                <?php } ?></td>
            </tr>
          </table>
