      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <div id="tab-mail">
          <table class="form">
            ...
            <tr>
              <td>开启SSL</td>
              <td><select name="config_smtp_ssl">
              	 <?php if ($config_smtp_ssl == '0') { ?>
                  <option value="0" selected="selected">关闭</option>
                  <?php } else { ?>
                 	 <option value="0"></option>
                  <?php } ?>
                  <?php if ($config_smtp_ssl == 'SSL') { ?>
                  <option value="SSL" selected="selected">开启</option>
                  <?php } else { ?>
                  <option value="SSL">开启</option>
                  <?php } ?>
                </select></td>
            </tr>
            <tr>
