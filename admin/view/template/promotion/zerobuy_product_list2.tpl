<?php if ($error_warning) { ?>
  ...
  <div class="box">
    <div class="heading">
      ...
      <div class="buttons">
      	<?php echo $text_start_date;?>:<input type="text" id="startDateHead" name="startDateHead" value="" class="datetime">
    	 <?php echo $text_end_date;?>:<input type="text" id="endDateHead" name="endDateHead" value="" class="datetime">
    	 <?php echo $text_group;?>:<input type="text" id="group" name="group" value="" placeholder="促销分组">
        ...
        <table class="list">
          <thead>
            <tr>
              ...
              <td class="left span5"><?php if ($sort == 'pd.name') { ?>
                ...
                <?php } ?></td>
      		  <td class="span2"><?php echo $column_category;?></td>
              <td class="left span2"><?php if ($sort == 'p.model') { ?>
             ...
             <td class="left span2"><?php if ($sort == 'p.sku') { ?>
              ...
              <td class="right"><?php if ($sort == 'p.quantity') { ?>
                ...
                <?php } ?></td>
              <td class="left span1"><?php if ($sort == 'p.status') { ?>
          ...
          <tbody>
            <tr class="filter" >
              ...
              <td><input type="text" name="filter_model" class="span2"  value="<?php echo $filter_model; ?>" /></td>
...
function filter() {
	url = 'index.php?route=promotion/zerobuy&token=<?php echo $token; ?>&type=<?php echo $type;?>&pr_id=<?php echo $pr_id;?>';
...
$(document).ready(
		function(){
			$('#startDateHead').bind('change',function(){
				$('#start_date').val($(this).val());
			});

			$('#endDateHead').bind('change',function(){
