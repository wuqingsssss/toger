        ...
        <div style="display: inline-block; width: 100%;">
          ...
          <div id="tab-general" class="vtabs-content">
            <table class="form">
              ...
              <tr>
                <td><?php echo $entry_first_price; ?></td>
                <td><input type="text" name="weight_first_price" value="<?php echo $weight_first_price; ?>" /></td>
              </tr>
              <tr>
                <td><?php echo $entry_continued_price; ?></td>
                <td><input type="text" name="weight_continued_price" value="<?php echo $weight_continued_price; ?>" /></td>
              </tr>
            </table>
          </div>
          <?php foreach ($geo_zones as $geo_zone) { ?>
