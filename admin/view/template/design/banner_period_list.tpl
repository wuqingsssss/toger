...
<div class="box">
    <div class="heading">
        <div class="btn-toolbar">
            ...
            <div class="buttons">
                <a href="index.php?route=design/banner_period/insert&banner_id=<?php echo $banner_id; ?>" class="btn btn-primary">新增</a>
                <a class="btn btn-primary" id="remove-btn">删除</a>
            </div>
        </div>
    </div>
    <div class="content">
                ...
                <?php if ($results) { ?>
                    <?php foreach ($results as $item) { ?>
                        <tr>
                            ...
                            <td class="left"><?php echo $item['itemsNum']; ?></td>
                            <td class="right">
                                [
                                <a href="index.php?route=design/banner_period/update&id=<?php echo $item['id']; ?>&banner_id=<?php echo $banner_id; ?>">查看</a>
                                ]
                            </td>
                        </tr>
                    <?php } ?>
...
<script type="text/javascript">
    ...
    $('#remove-btn').click(function () {
        ...
        $.ajax({
            url:'index.php?route=design/banner_period/delete',
            type: 'POST',
            dataType: 'json',
