          ...
          <table class="form">
            ...
            <tr>
              ...
              <td><select name="display">
                  <?php foreach($displays as $result) {?>
                  <option value="<?php echo $result['value']; ?>" <?php if($result['value']==$display) {?> selected="selected"<?php }?>><?php echo $result['text']; ?></option>
                  <?php } ?>
                </select></td>
            </tr>
          </table>
          ...
          <table class="list">
            ...
            <tbody>
              <tr>
                ...
                <td class="left"><select name="ncategory_layout[0][layout_id]">
                    <option value=""></option>
            ...
            <tbody>
              <tr>
                ...
                <td class="left"><select name="ncategory_layout[<?php echo $store['store_id']; ?>][layout_id]">
                    <option value=""></option>
                    <?php foreach ($layouts as $layout) { ?>
