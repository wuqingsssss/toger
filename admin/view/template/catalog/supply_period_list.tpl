...
<div class="box">
    <div class="heading">
        <div class="btn-toolbar">
            ...
            <div class="buttons">
                <a href="index.php?route=catalog/supply_period/insert" class="btn btn-primary">新增</a>
        ...
        <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form">
            <table class="list">
                ...
                <tr>
                    ...
                    <td class="left span3">t+n周期名称</td>
                    <td class="left span3">预售名称</td>
                    <td class="left span3">当期名称</td>
                    <td class="left span3">展示开始</td>
                    <td class="left span3">展示结束</td>                 
                    <td class="left span3">取菜开始</td>
                    <td class="left span3">取菜结束</td>
                ...
                <?php if ($results) { ?>
                    <?php foreach ($results as $item) { ?>
                        <tr>
                            ...
                            <td class="left"><?php echo $item['name2']; ?></td>
                            ...
                            <td class="left"><?php echo date('Y-m-d', strtotime($item['p_start_date'])); ?></td>
                            <td class="left"><?php echo date('Y-m-d', strtotime($item['p_end_date'])); ?></td>
                            ...
                            <td class="right">
                                [
                                <a href="index.php?route=catalog/supply_period/update&id=<?php echo $item['id']; ?>">查看</a>
                                ]
                            </td>
                        </tr>
                    <?php } ?>
