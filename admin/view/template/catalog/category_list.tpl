       ...
       <table class="list">
          <thead>
            <tr>
              ...
              <td class="left span2"><?php echo $column_status; ?></td>
              <td class="left span2"><?php echo $column_products; ?></td>
              <td class="left span2"><?php echo $column_sort_order; ?></td>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="left"><?php echo $category['products']; ?></td>
