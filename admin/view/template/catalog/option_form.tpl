        ...
        <table class="form">
          ...
          <tr>
            ...
            <td><select name="type">
                ...
                <?php if ($type == 'autocomplete') { ?>
                <option value="autocomplete" selected><?php echo $text_autocomplete; ?></option>
                <?php } else { ?>
                <option value="autocomplete"><?php echo $text_autocomplete; ?></option>
                <?php } ?>
                ...
                <?php if ($type == 'virtual_product') { ?>
                <option value="virtual_product" selected><?php echo $text_virtual_product; ?></option>
                <?php } else { ?>
                <option value="virtual_product"><?php echo $text_virtual_product; ?></option>
                <?php } ?>
                </optgroup>
              </select></td>
          </tr>
        ...
        <table id="option-value" class="list">
          ...
          <tbody id="option-value-row<?php echo $option_value_row; ?>">
            <tr>
              ...
              <td class="left"><a onclick="$('#option-value-row<?php echo $option_value_row; ?>').remove();" class="btn"><?php echo $button_remove; ?></a></td>
            </tr>
          </tbody>
          ...
          <tfoot>
            <tr>
              <td colspan="2"></td>
              <td class="left"><a onclick="addOptionValue();" class="btn"><?php echo $button_add_option_value; ?></a></td>
            </tr>
          </tfoot>
        </table>
      </form>
...
$('select[name=\'type\']').bind('change', function() {
	if (this.value == 'select' || this.value == 'radio' || this.value == 'checkbox'|| this.value == 'color'|| this.value == 'virtual_product' || this.value == 'autocomplete') {
		$('#option-value').show();
	} else {
		$('#option-value').hide();	
	}
...
function addOptionValue() {
	...
	html += '<td class="left"><a onclick="$(\'#option-value-row' + option_value_row + '\').remove();" class="btn"><?php echo $button_remove; ?></a></td>';
	html += '</tr>';	
    html += '</tbody>';
