...
$_['entry_weight_code']            = '重量代码:<br /><span class="help">请输入ups认可的重量代码，公斤或磅.</span>';
$_['entry_weight_class']           = '重量类别:<span class="help">设置为公斤或磅.</span>';
$_['entry_length_code']            = '尺寸代码:<br /><span class="help">请输入ups认可的尺寸代码.</span>';
$_['entry_length_class']           = '尺寸类型:<span class="help">请设置为公分或英寸.</span>';
$_['entry_dimension']              = '包装尺寸 (长 x 宽 x 高):';
$_['entry_tax']                    = '稅率类別:';
