...
class ModelAccountReward extends Model {	
	...
	public function addReward($data){
		$sql="INSERT INTO `" . DB_PREFIX . "customer_reward` SET customer_id=".(int)$data['customer_id']
		.",points=".(int)$data['points']
		.",order_id='".$this->db->escape($data['order_id'])."',description='".$this->db->escape($data['description'])."',date_added=NOW()";
