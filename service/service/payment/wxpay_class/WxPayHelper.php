...
class Common_util_
{
	...
	function postXmlSSLCurl($xml,$url)
	{
		...
		curl_setopt($ch,CURLOPT_SSLCERT, DIR_ROOT.'service/service/payment/wxpay_class/cacert/apiclient_cert.pem');
		curl_setopt($ch,CURLOPT_SSLKEYTYPE,'PEM');
		//curl_setopt($ch,CURLOPT_SSLKEY, WxPayConf::SSLKEY_PATH);
		curl_setopt($ch,CURLOPT_SSLKEY, DIR_ROOT.'service/service/payment/wxpay_class/cacert/apiclient_key.pem');
		//post提交方式
