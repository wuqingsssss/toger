...
class AlipayNotify {
	...
	function verifyNotifyWap(){
		if(empty($_POST)) {//判断POST来的数组是否为空
			...
			$this->log->info($decrypt_post_para['notify_data']);
     ...
     * @return 签名验证结果
     */
	function getSignVeryfy($para_temp, $sign, $isSort=true) {
		//除去待签名参数数组中的空值和签名参数
