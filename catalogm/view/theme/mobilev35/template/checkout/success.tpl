...
<div class="fm-16 bg-white">
    <ul class="order-suc">
        <li class="col-red"><?php echo $text_success_title;?></li>
        <li class="fm-14 col-gray"><?php echo $text_success_link;?></li>
...
<div class="fm-14">
    <ul class="order-add">
        ...
        <li class="col-gray">
            ...
            <div><span>配送时间：</span><span><?php echo date('Y-m-d H:i',strtotime($order_info['shipping_time'])-3600).'-'.date('H:i',strtotime($order_info['shipping_time']));?></span></div>
