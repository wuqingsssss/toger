	    ...
	    <tbody>
	            ...
	            <?php foreach ($products as $product) { ?>
		     	 <tr>
		              ...
		              <th class="quantity" style="width: 10%;"><?php echo "×".$product['quantity']; ?></th>
			        
			          <th class="total" style="text-align: right;width: 22%;"><?php echo $this->currency->format($product['total']); ?></th>
		         </tr>
		      <?php } ?>
	       <?php } ?>
	   </tbody>
