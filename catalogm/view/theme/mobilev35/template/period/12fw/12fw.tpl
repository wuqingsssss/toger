...
<?php
$tplPath = 'catalogm/view/theme/'.$this->config->get('config_template').'/template/period/'.$supply_period['template'].'/';
$cssPath = 'catalogm/view/theme/'.$this->config->get('config_template').'/template/period/'.$supply_period['template'].'/';
$jsPath =  'catalogm/view/theme/'.$this->config->get('config_template').'/template/period/'.$supply_period['template'].'/js/';
$imgPath = 'catalogm/view/theme/'.$this->config->get('config_template').'/template/period/'.$supply_period['template'].'/img/';
?>
