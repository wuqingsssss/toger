...
jQuery.fn.extend({
	delayLoading:function(a){
		...
		function h(d){
			...
			if(a.container===undefined||a.container===window)
			{
				b=$(window).scrollLeft();c=$(window).width()+$(window).scrollLeft()
		    }else{
		...
		function f(){
			...
			e.filter("img["+a.imgSrcAttr+"]").each(function(d,b){
				   ...
				   h($(b))||!a.event))
				{
					...
					c.onerror=function(){
						if(a.errorImg)$(b).attr("src",a.errorImg);
				//		$(b).removeAttr(a.imgSrcAttr);
						a.error($(b));		
					};
		...
		var e=$(this);
		if(e.attr("src")===undefined||e.attr("src")===null||e.attr("src")==="")
			if(a.defaultImg)e.attr("src",a.defaultImg);
		f();
