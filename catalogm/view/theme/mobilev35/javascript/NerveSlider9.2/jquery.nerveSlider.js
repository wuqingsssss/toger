...
(function($) {
	...
	$.fn.nerveSlider = function(userOptions) {
		...
		return $(this).each(function(){
			...
			//Comment out by CWW 2015-04-22
			// For Nerve Slider analytics.  You may remove if necessary.
		//	$(self).find(".ns_extras").append("<img src='http://code.ryanbruzan.net/nerveSlider/log/pixel.php?a="+document.URL.replace("&","&amp;").replace("http://","[http]").replace("https://","[https]").replace(/\//gi,"[slash]")+"&v="+nsVersion+"' style='display:none;' class='ns_logImg'>"); // Store the ns_current URL
