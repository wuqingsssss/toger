...
<div id="content" ><?php echo $content_top; ?>
  ...
  <div class="product-info">
    ...
    <div class="left">
        <?php if ($thumb) { ?>
	      ...
	      <img   height="<?php echo $image_thumb_height; ?>" width="<?php echo $image_thumb_width; ?>" src="<?php echo $thumb; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" id="image"   /></a></div>
	  	<?php } ?>
      <?php if ($images) { ?>
  ...
  <div id="tab-related" class="tab-content">
  	<h2><span><?php echo $tab_related; ?> (<?php echo count($products); ?>)</span></h2>
    <div class="box-product" id="related-jcarousel" >
    <ul class="jcarousel-skin-opencart">
