...
class ControllerPaymentBankTransfer extends Controller {
	...
	public function confirm() {
		...
		$this->log_payment->debug('IlexDebug:: Checkout BankTransfer confirm() : order_id '.$this->session->data['order_id'].' | order_status '.$this->config->get('bank_transfer_order_status_id'));
