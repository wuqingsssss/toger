	...
	public function index() { 
		...
		if ($ncategory_info) {
			...
			foreach ($results as $result) {
				...
				$article_results=$this->model_catalog_ncategory->getArticles($result['ncategory_id']);
				
				
				foreach($article_results as $article_result){
					$articles[]=array(
						'name' => $article_result['title'],
						'image' => HTTPS_IMAGE.$article_result['image'],
					);
				}
			...
			if(!$ncategory_info['display']){
				...
				if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/news/ncategory_'.$ncategory_info['display'].'.tpl')) {
					$this->template = $this->config->get('config_template') . '/template/news/ncategory_'.$ncategory_info['display'].'.tpl';
				} else {
					$this->template = 'default/template/news/ncategory_'.$ncategory_info['display'].'.tpl';
				}
			}
  	...
  	public function display_list(){
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/news/ncategory_list.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/news/ncategory_list.tpl';
		} else {
			$this->template = 'default/template/news/ncategory_list.tpl';
		}
  	...
  	public function display_tab(){
		...
		$this->data['pagination'] = $pagination->render();
  		...
  		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/news/ncategory_tab.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/news/ncategory_tab.tpl';
		} else {
			$this->template = 'default/template/news/ncategory_tab.tpl';
		}
