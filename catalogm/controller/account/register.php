...
//                var_dump($id);
                ...
                if ($this->config->get('config_active') == '1') {
                    ...
                    if($result) {
                        ...
                        if(!empty($result['packet_id'])){
                            ...
                            if($ret==1){  //追加成功
                                // 更新红包名称
                                $this->session->data['packet_name'] = $result['name'];
                            }
                        }
        ...
        if ($this->config->get('config_account_id')) {
            ...
            if ($information_info) {
								$this->data['agree_url'] = $this->url->link('information/information'.'&information_id=' . $this->config->get('config_account_id'),'','SSL');
